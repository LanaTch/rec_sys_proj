...
class MainRecommender:
    ...
    def __init__(self, data):        
        ...
        self.prep_data = data   
        print("prepare user_item_matrix...")
        ...
        print("fit ALS BM25 model...")
        self.model_bm25  = self.fit(self.user_item_matrix_bm25)
        print('done')
        self.als_user_factors = self.model_bm25.user_factors
        self.als_item_factors = self.model_bm25.item_factors
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=64, regularization=0.05, iterations=15, num_threads=4):
        """Обучает ALS"""
